...
setopt PROMPT_SUBST
export PROMPT='${NEWLINE}$PROMPT_TIME %F{grey} $RUBY $NODE %F{red}%F{white} $(git_branch) ${NEWLINE}%F{blue}%~%F{grey} ${NEWLINE}%F{blue}~%F{grey} ${PS1_EMOJIS[$RANDOM % $NUMBER_OF_EMOJIS]} '
